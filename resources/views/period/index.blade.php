...
@section('content-header')
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Period List</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">
            <i class="fa fa-table"></i> Period List
          </h3>
          <div class="card-tools">
            <a href="{{ url('period/create') }}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="Create new Period">
              Create
            </a>
          </div>
        </div>
  ...
  <div class="modal fade" id="modal-delete">
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        <form method="POST" action="{{ url('period/delete') }}" class="form-horizontal" id="form-delete">
          @csrf
