...
@section('content')
<form method="POST" action="{{ url('user') }}" class="form-horizontal" id="form-create">
  @csrf
  <div class="row">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-md-9">
                <input id="daily_rate" type="text" class="form-control{{ $errors->has('daily_rate') ? ' is-invalid' : '' }}" name="daily_rate" value="{{ old('daily_rate') ?? 0 }} ">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
                <input id="monthly_rate" type="text" class="form-control{{ $errors->has('monthly_rate') ? ' is-invalid' : '' }}" name="monthly_rate" value="{{ old('monthly_rate') ?? 0 }}">
